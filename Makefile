...
.PHONY: test-e2e
test-e2e: manifests generate fmt vet ## Run the kind e2e (5 scenarios + metrics + logs). Requires: docker, kind, helm on PATH.
	KIND_CLUSTER=$(KIND_CLUSTER) bash ./test/e2e/run.sh
